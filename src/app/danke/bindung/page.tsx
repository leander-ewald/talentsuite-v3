  ...
  return (
    <div style={{ background: "#f0f4f7", minHeight: "100vh" }}>
      <div className="px-4 md:px-6 pt-24 md:pt-32 pb-[72px] md:pb-[104px]" style={{ background: "linear-gradient(135deg, #011E2F 0%, #023B5B 50%, #0A4D72 100%)", textAlign: "center" }}>
        ...
        <h1 className="text-[24px] md:text-[36px]" style={{ color: "#ffffff", fontWeight: 800, margin: "0 0 12px", lineHeight: 1.15 }}>Ihr Toolkit ist unterwegs!</h1>
        <p className="text-[15px] md:text-[18px]" style={{ color: "rgba(255,255,255,0.7)", maxWidth: 520, margin: "0 auto" }}>Prüfen Sie Ihr Postfach — 5 praxiserprobte Tools warten auf Sie.</p>
      </div>
