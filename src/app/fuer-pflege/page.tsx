...
const positionen = [
  { name: "Pflegefachkraft", slug: "pflege", stellen: "78.000", cpa: "18-28\u20AC" },
  { name: "Pflegehelfer", slug: "pflege", stellen: "42.000", cpa: "14-20\u20AC" },
  { name: "Pflegedienstleitung", slug: "pflege", stellen: "12.000", cpa: "25-40\u20AC" },
];
    ...
    <div style={{ background: "#f0f4f7", minHeight: "100vh" }}>
      ...
      >
        ...
        >
          ...
          Pflegekr&auml;fte finden &mdash;{" "}
          <span style={{ color: "#1B98E0" }}>
            Performance Recruiting f&uuml;r Pflegeeinrichtungen
          </span>
        </h1>
        <p
          style={{
        ...
        >
          ...
          Der Pflegenotstand ist real &mdash; aber Ihre L&ouml;sung muss nicht Zeitarbeit sein.
        </p>
      </div>
