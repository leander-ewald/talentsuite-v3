...
export default function SocialMediaManagementPage() {
  return (
    <>
      ...
      <MainSection title={<>Social Media, das <span className="text-[var(--color-accent)]">konvertiert</span> &ndash;<br />mehr Sichtbarkeit, mehr Wirkung.</>} description="Wir managen deine Social-Media-Kanäle strategisch, kreativ und datengetrieben -- damit aus Reichweite echte Ergebnisse werden." buttonText="Jetzt Social-Media-Beratung buchen" imageSrc="/assets/services/social.svg" imageAlt="Social Media Management -- Professionelle Kanalbetreuung" />
