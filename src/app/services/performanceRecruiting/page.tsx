...
export default function PerformanceRecruitingPage() {
  return (
    <>
      ...
      <MainSection title={<>Dein Recruiting braucht<br />kein Glück &ndash;<br /><span className="text-[var(--color-accent)]">es braucht System.</span></>} description="Wir helfen dir, passende Bewerber:innen zu gewinnen -- mit datenbasierten Kampagnen, smarten Funnels und hoher Abschlussquote." buttonText="Jetzt Beratungsgespräch buchen" imageSrc="/assets/services/recruiting.webp" imageAlt="Performance Recruiting -- Qualifizierte Bewerbungen über Social Media" />
