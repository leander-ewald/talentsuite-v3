...
export default function WebDevelopmentPage() {
  return (
    <>
      ...
      <MainSection title={<>Deine Website ist dein<br />bester <span className="text-[var(--color-accent)]">Vertriebler</span> &ndash; 24/7.</>} description="Wir entwickeln performante, SEO-optimierte Websites, die Vertrauen schaffen und Besucher in Kunden verwandeln." buttonText="Jetzt Web-Beratung buchen" imageSrc="/assets/services/webdev.svg" imageAlt="Webentwicklung -- Moderne Websites mit React und Next.js" />
