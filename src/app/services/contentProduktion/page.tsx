...
export default function ContentProduktionPage() {
  return (
    <>
      ...
      <MainSection title={<>Content, der <span className="text-[var(--color-accent)]">wirkt</span> &ndash;<br />nicht nur gefällt.</>} description="Wir produzieren Videos, Fotos und Social Media Content, der deine Marke authentisch zeigt und messbare Ergebnisse liefert." buttonText="Jetzt Content-Beratung buchen" imageSrc="/assets/services/content.svg" imageAlt="Content Produktion -- Video, Foto und Social Media Content" />
